package com.ss10_customer.controller;

import com.ss10_customer.model.Customer;
...
@WebServlet(name = "CustomerListServlet", value = "/")
public class CustomerListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("WEB-INF/ss10_index_customerList/display.jsp").forward(req, resp);
    }
